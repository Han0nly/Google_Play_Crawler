...
class GoogleSpider(CrawlSpider):
    name = 'fda'
    allowed_domains = ['play.google.com','healthskouts.com']
    start_urls = ["https://apps.healthskouts.com/",]
                  # 'https://play.google.com/store/apps/details?id=com.viber.voip']

    rules = (
        Rule(LinkExtractor(allow=('https://apps.healthskouts.com/',)), follow=True),
        Rule(LinkExtractor(allow=("/store/apps/details", )), follow=False, callback='parse_link'),
    )
